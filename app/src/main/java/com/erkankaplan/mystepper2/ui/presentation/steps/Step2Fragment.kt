...
import com.erkankaplan.mystepper2.databinding.ColorChangeFragmentBinding
import com.erkankaplan.mystepper2.databinding.Step2Binding
...
class Step2Fragment : Fragment() {
    ...
    private lateinit var viewBinding: Step2Binding
    ...
    override fun onCreateView(
        ...
        viewBinding = Step2Binding.inflate(inflater, container, false).apply {
            setupUI()
        }
